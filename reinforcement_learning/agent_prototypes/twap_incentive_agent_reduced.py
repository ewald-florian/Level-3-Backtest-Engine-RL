...
This is a reduced form of the TWAP incentive agent where the observation
space is reduced to only features which are relevant for the twap incentive,
no additional market features.
...
class TwapIncentiveAgentReduced(RlBaseAgent):
    """
    ...
    def __init__(self,
        ...
        self.market_features = MarketFeatures()
        self.agent_metrics = AgentMetrics()
        # Give the initial inventory to the agent as input to compute the
        # twap quantity.
