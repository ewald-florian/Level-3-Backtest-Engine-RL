...
from reinforcement_learning.environment.tradingenvironment import \
    TradingEnvironment
from reinforcement_learning.agent_prototypes.archieve.twap_incentive_agent_reduced \
...
stats_path = generate_episode_stats_path(name='in_loop_new_new')
...
agent = TwapIncentiveAgentReduced(verbose=True)
...
config["env_config"]["observation_size"] = 3  # Only agent observation.
