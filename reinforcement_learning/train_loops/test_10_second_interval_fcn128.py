...
result_file = generate_result_path(name='fcn128_10_sec_wait')
print("RESULT_FILE:", result_file)
# generate json file to store episode statistics.
stats_path = generate_episode_stats_path(name='fcn128_10_sec_wait')
...
# TODO: Problem, is there a real bug or is it just due to the env checking
