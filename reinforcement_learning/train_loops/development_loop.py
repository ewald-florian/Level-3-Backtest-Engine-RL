...
# Create empty model dict (since I have no default config anymore)
config["model"] = {}
...
# Iteration counter, how often was the agent trained so far.
print(rllib_trainer.iteration)
# Current policy weights.
print(rllib_trainer.get_weights())
